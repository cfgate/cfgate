...
BackendTLSPolicy can change the generated origin service scheme to HTTPS. That conflicts with h2c because h2c is cleartext HTTP/2 and requires HTTP origin protocol.
